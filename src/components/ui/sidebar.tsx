      ...
      >
        ...
        <div
          className={cn(
            ...
            variant === "floating" || variant === "inset"
              ? "left-4 top-4 h-[calc(100svh-theme(spacing.8))] w-[calc(var(--sidebar-width)-theme(spacing.8))] rounded-lg border border-sidebar-border bg-sidebar shadow-lg"
        ...
        >
          <div
            data-sidebar="sidebar"
            className="flex h-full w-full flex-col bg-sidebar group-data-[variant=floating]:border-sidebar-border group-data-[variant=floating]:border group-data-[variant=floating]:rounded-lg"
          >
            {children}
          </div>
        </div>
